...
class $SchedulesTable extends Schedules
  ...
  late final GeneratedColumn<int> colorId = GeneratedColumn<int>(
      ...
      type: DriftSqlType.int, requiredDuringInsert: true);
  static const VerificationMeta _cratedAtMeta =
      const VerificationMeta('cratedAt');
  @override
  late final GeneratedColumn<DateTime> cratedAt = GeneratedColumn<DateTime>(
      'crated_at', aliasedName, false,
      type: DriftSqlType.dateTime,
      requiredDuringInsert: false,
      clientDefault: () => DateTime.now());
  @override
  List<GeneratedColumn> get $columns =>
      [id, content, date, startTime, endTime, colorId, cratedAt];
  @override
  ...
  VerificationContext validateIntegrity(Insertable<Schedule> instance,
    ...
    if (data.containsKey('crated_at')) {
      context.handle(_cratedAtMeta,
          cratedAt.isAcceptableOrUnknown(data['crated_at']!, _cratedAtMeta));
    }
    return context;
  }
  ...
  Schedule map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Schedule(
      ...
      cratedAt: attachedDatabase.typeMapping
          .read(DriftSqlType.dateTime, data['${effectivePrefix}crated_at'])!,
    );
  }
...
class Schedule extends DataClass implements Insertable<Schedule> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['crated_at'] = Variable<DateTime>(cratedAt);
    return map;
  }
  ...
  factory Schedule.fromJson(Map<String, dynamic> json,
    ...
    return Schedule(
      ...
      cratedAt: serializer.fromJson<DateTime>(json['cratedAt']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'cratedAt': serializer.toJson<DateTime>(cratedAt),
    };
  }
  ...
  @override
  int get hashCode =>
      Object.hash(id, content, date, startTime, endTime, colorId, cratedAt);
  @override
...
class SchedulesCompanion extends UpdateCompanion<Schedule> {
  ...
  const SchedulesCompanion({
    ...
    this.cratedAt = const Value.absent(),
  });
  ...
  static Insertable<Schedule> custom({
    ...
    return RawValuesInsertable({
      ...
      if (cratedAt != null) 'crated_at': cratedAt,
    });
  }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (cratedAt.present) {
      map['crated_at'] = Variable<DateTime>(cratedAt.value);
    }
    return map;
  }
